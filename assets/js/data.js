...
const TL_TRACKS = [
  { slot: 'A', label: '인물 A', clips: [
    { n: 1, cam: '1F 메인 복도',  img: IMG('obj01'), from: '2026-06-29 08:14:05', to: '2026-06-29 08:31:40',
      extra: [{ cam: '1F 메인 복도(북)', img: IMG('cam2') }, { cam: '1F 메인 복도(남)', img: IMG('cam3') }] },
    { n: 2, cam: 'B1 엘리베이터', img: IMG('obj13'), from: '2026-06-29 09:02:11', to: '2026-06-29 09:15:02' },
    { n: 3, cam: 'B1 주차장',     img: IMG('obj02'), from: '2026-06-29 10:05:47', to: '2026-06-29 10:22:19',
      extra: [{ cam: 'B1 주차장(램프)', img: IMG('cam4') }] },
    { n: 4, cam: '외부 CCTV',     img: IMG('obj20'), from: '2026-06-29 11:31:08', to: '2026-06-29 11:44:52' }
  ] },
  { slot: 'B', label: '인물 B', clips: [
    { n: 1, cam: '1F 로비',       img: IMG('obj05'), from: '2026-06-29 08:40:00', to: '2026-06-29 08:58:30' },
    { n: 2, cam: '2F 통로',       img: IMG('obj08'), from: '2026-06-29 09:44:12', to: '2026-06-29 09:59:01' },
    { n: 3, cam: 'B1 입구',       img: IMG('obj11'), from: '2026-06-29 10:48:22', to: '2026-06-29 11:03:10' }
  ] },
  { slot: 'C', label: '인물 C', clips: [
    { n: 1, cam: '3F 매장',       img: IMG('obj16'), from: '2026-06-29 08:55:31', to: '2026-06-29 09:12:44' },
    { n: 2, cam: '1F 메인 복도',  img: IMG('obj18'), from: '2026-06-29 10:20:05', to: '2026-06-29 10:37:29',
      extra: [{ cam: '1F 메인 복도(북)', img: IMG('cam2') }] }
  ] },
  { slot: 'D', label: '인물 D', clips: [
    { n: 1, cam: 'B1 주차장',     img: IMG('obj24'), from: '2026-06-29 09:20:40', to: '2026-06-29 09:36:12' },
    { n: 2, cam: '외부 CCTV',     img: IMG('obj27'), from: '2026-06-29 11:10:33', to: '2026-06-29 11:26:00' },
    { n: 3, cam: '1F 로비',       img: IMG('obj30'), from: '2026-06-29 12:02:18', to: '2026-06-29 12:19:44' }
  ] }
];
