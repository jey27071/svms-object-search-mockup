...
const OBJECTS = [
  ...
  { id: 'o13', img: IMG('obj04'), sim: 93, cam: '1층 로비',      t: '2026-06-30 13:15:02', group: 'c2', type: '인물', sex: '여성', top: 'white', bottom: 'black' },
  { id: 'o14', img: IMG('obj05'), sim: 92, cam: '2층 통로',      t: '2026-06-30 13:11:48', group: 'c2', type: '인물', sex: '여성', top: 'white', bottom: 'black' },
  { id: 'o15', img: IMG('obj29'), sim: 82, cam: 'B1 엘리베이터', t: '2026-06-30 13:06:25', group: 'c2', type: '인물', sex: '여성', top: 'white', bottom: 'black' },

  /* --- 기타 유사 대상 (15건) --- */
  { id: 'o16', img: IMG('obj02'), sim: 93, cam: '외부 CCTV',   t: '2026-06-30 12:58:31', group: 'etc', type: '인물', sex: '여성', top: 'green',  bottom: 'black' },
  { id: 'o17', img: IMG('obj03'), sim: 90, cam: '외부 CCTV',   t: '2026-06-30 12:51:19', group: 'etc', type: '인물', sex: '남성', top: 'gray',   bottom: 'black' },
  { id: 'o18', img: IMG('obj06'), sim: 88, cam: '외부 CCTV',   t: '2026-06-30 12:44:07', group: 'etc', type: '인물', sex: '여성', top: 'green',  bottom: 'black' },
  { id: 'o19', img: IMG('obj08'), sim: 87, cam: 'B1 주차장',     t: '2026-06-30 12:38:52', group: 'etc', type: '인물', sex: '남성', top: 'blue',   bottom: 'blue'  },
  { id: 'o20', img: IMG('obj10'), sim: 86, cam: '3층 매장',  t: '2026-06-30 12:31:40', group: 'etc', type: '인물', sex: '여성', top: 'black',  bottom: 'black' },
  { id: 'o21', img: IMG('obj11'), sim: 85, cam: 'B1 입구',       t: '2026-06-30 12:25:14', group: 'etc', type: '인물', sex: '남성', top: 'blue',   bottom: 'blue'  },
  { id: 'o22', img: IMG('obj15'), sim: 84, cam: '2층 통로',      t: '2026-06-30 12:18:03', group: 'etc', type: '인물', sex: '여성', top: 'blue',   bottom: 'black' },
  { id: 'o23', img: IMG('obj16'), sim: 82, cam: '외부 CCTV',   t: '2026-06-30 12:09:47', group: 'etc', type: '인물', sex: '남성', top: 'green',  bottom: 'black' },
  { id: 'o24', img: IMG('obj17'), sim: 80, cam: '외부 CCTV',   t: '2026-06-30 12:02:35', group: 'etc', type: '인물', sex: '여성', top: 'green',  bottom: 'black' },
  { id: 'o25', img: IMG('obj19'), sim: 84, cam: '3층 매장',  t: '2026-06-30 11:55:22', group: 'etc', type: '인물', sex: '남성', top: 'gray',   bottom: 'black' },
  { id: 'o26', img: IMG('obj21'), sim: 83, cam: 'B1 주차장',     t: '2026-06-30 11:47:09', group: 'etc', type: '인물', sex: '여성', top: 'blue',   bottom: 'blue'  },
  { id: 'o27', img: IMG('obj22'), sim: 82, cam: '1층 로비',      t: '2026-06-30 11:39:56', group: 'etc', type: '인물', sex: '남성', top: 'brown',  bottom: 'black' },
  { id: 'o28', img: IMG('obj26'), sim: 81, cam: 'B1 엘리베이터', t: '2026-06-30 11:31:44', group: 'etc', type: '인물', sex: '여성', top: 'black',  bottom: 'black' },
  { id: 'o29', img: IMG('obj27'), sim: 80, cam: '외부 CCTV',   t: '2026-06-30 11:24:31', group: 'etc', type: '인물', sex: '남성', top: 'brown',  bottom: 'black' },
  { id: 'o30', img: IMG('obj28'), sim: 80, cam: 'B1 주차장',     t: '2026-06-30 11:16:18', group: 'etc', type: '인물', sex: '여성', top: 'black',  bottom: 'black' },

  /* --- 유사도 80% 미만 : 기본 검색에서는 제외, '모든 결과 출력' 시 노출 --- */
  { id: 'o31', img: IMG('obj30'), sim: 78, cam: 'B1 엘리베이터', t: '2026-06-30 10:58:04', group: 'etc', type: '인물', sex: '남성', top: 'black',  bottom: 'black' },
  { id: 'o32', img: IMG('ai03'),  sim: 75, cam: '1층 로비',      t: '2026-06-30 10:44:51', group: 'etc', type: '인물', sex: '여성', top: 'black',  bottom: 'black' },
  { id: 'o33', img: IMG('ai10'),  sim: 72, cam: '2층 통로',      t: '2026-06-30 10:31:38', group: 'etc', type: '인물', sex: '남성', top: 'black',  bottom: 'black' },
  { id: 'o34', img: IMG('ai11'),  sim: 68, cam: '외부 CCTV',   t: '2026-06-30 10:18:25', group: 'etc', type: '인물', sex: '여성', top: 'blue',   bottom: 'blue'  },
  { id: 'o35', img: IMG('ai13'),  sim: 60, cam: '외부 CCTV',   t: '2026-06-30 10:05:12', group: 'etc', type: '인물', sex: '남성', top: 'blue',   bottom: 'blue'  }
];
